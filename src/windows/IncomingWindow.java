...
public class IncomingWindow extends Application {
    ...
    IncomingWindow(WebClient client, MainWindow window){
        webClient = client;
        mainWindow = window;
    ...
    public void start(Stage st) throws Exception {
        stage = st;
        ObservableList<Button> friends = getIncomingMessages();
        createBack();
    ...
    private ObservableList<Button> getIncomingMessages() throws IllegalAccessException, IOException {
        String answer = webClient.getIncomingMessages();
